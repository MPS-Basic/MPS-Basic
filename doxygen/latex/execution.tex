\chapter{Execution}
\hypertarget{execution}{}\label{execution}\index{Execution@{Execution}}
\hypertarget{execution_autotoc_md0}{}\doxysubsection{\texorpdfstring{Requirements}{Requirements}}\label{execution_autotoc_md0}
\hypertarget{execution_autotoc_md1}{}\doxysubsubsection{\texorpdfstring{Execution}{Execution}}\label{execution_autotoc_md1}
...
\end{DoxyItemize}\hypertarget{execution_autotoc_md2}{}\doxysubsubsection{\texorpdfstring{Development}{Development}}\label{execution_autotoc_md2}

\begin{DoxyItemize}
\item Doxygen and Graphviz (optional, for building documents)
\end{DoxyItemize}\hypertarget{execution_autotoc_md3}{}\doxysubsubsection{\texorpdfstring{Dependencies}{Dependencies}}\label{execution_autotoc_md3}
...
\end{DoxyItemize}\hypertarget{execution_autotoc_md4}{}\doxysubsection{\texorpdfstring{Command Line Execution}{Command Line Execution}}\label{execution_autotoc_md4}
...
\end{DoxyItemize}\hypertarget{execution_autotoc_md5}{}\doxysubsubsection{\texorpdfstring{Build}{Build}}\label{execution_autotoc_md5}
...
\end{DoxyItemize}\hypertarget{execution_autotoc_md6}{}\doxysubsubsection{\texorpdfstring{Execution}{Execution}}\label{execution_autotoc_md6}
\hypertarget{execution_autotoc_md7}{}\doxyparagraph{\texorpdfstring{Windows}{Windows}}\label{execution_autotoc_md7}
...
\end{DoxyEnumerate}\hypertarget{execution_autotoc_md8}{}\doxyparagraph{\texorpdfstring{Linux}{Linux}}\label{execution_autotoc_md8}
...
\end{DoxyCode}
\hypertarget{execution_autotoc_md9}{}\doxyparagraph{\texorpdfstring{Note}{Note}}\label{execution_autotoc_md9}
...
\end{DoxyCode}
 \hypertarget{execution_autotoc_md10}{}\doxysubsection{\texorpdfstring{Execution in Visual Studio Code}{Execution in Visual Studio Code}}\label{execution_autotoc_md10}
...
\end{DoxyImageNoCaption}
   \hypertarget{execution_autotoc_md11}{}\doxysubsubsection{\texorpdfstring{Build}{Build}}\label{execution_autotoc_md11}
...
\end{DoxyImageNoCaption}
   \hypertarget{execution_autotoc_md12}{}\doxysubsubsection{\texorpdfstring{Execution}{Execution}}\label{execution_autotoc_md12}
...
\end{DoxyItemize}\hypertarget{execution_autotoc_md13}{}\doxyparagraph{\texorpdfstring{Windows}{Windows}}\label{execution_autotoc_md13}

\begin{DoxyCode}{0}
\DoxyCodeLine{./scripts/windows.ps1}

\end{DoxyCode}
\hypertarget{execution_autotoc_md14}{}\doxyparagraph{\texorpdfstring{Linux}{Linux}}\label{execution_autotoc_md14}

\begin{DoxyCode}{0}
\DoxyCodeLine{./scripts/linux.sh}

\end{DoxyCode}
\hypertarget{execution_autotoc_md15}{}\doxyparagraph{\texorpdfstring{Note}{Note}}\label{execution_autotoc_md15}
...
\end{DoxyImageNoCaption}
   \hypertarget{execution_autotoc_md16}{}\doxysubsection{\texorpdfstring{Debugging in Visual Studio Code}{Debugging in Visual Studio Code}}\label{execution_autotoc_md16}
